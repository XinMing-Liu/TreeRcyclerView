package com.hongzhi.material.treerecyclerview.manager;

import com.hongzhi.material.treerecyclerview.base.BaseRecyclerAdapter;
...
/**
 * @Author XinMing-Liu
 * @create 2019/5/28 17:08
 */
public class ItemManagerImpl<T> extends ItemManager<T>{

    public ItemManagerImpl(BaseRecyclerAdapter<T> adapter) {
        super(adapter);
    }
